...
class Validation
{
    ...
    public $virus = [        
        ...
        'efectos_negativo' => 'required|min_length[1]|max_length[50]',
        'accion' => 'required|min_length[1]|max_length[50]'
    ];

    public $inspeccion = [        
        'accion' => 'required|min_length[1]|max_length[100]'
    ];

    public $incidencia = [        
        'acciones' => 'required|min_length[1]|max_length[100]'
    ];
