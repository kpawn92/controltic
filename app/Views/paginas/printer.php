...
<div class="preloader flex-column justify-content-center align-items-center">
    <h1 class="modal-title" id="exampleModalLabel">Impresoras</h1>
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Entrada de las impresoras</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">Formulario para el registro de las impresoras</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="<?= site_url("/reg_printer") ?>" id="quickForm">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            <label for="t_repuesto">Repuesto:</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" style="width: 100%;" id="fk_responsable" name="fk_responsable">
                                                <?php foreach ($responsables as $responsable) : ?>
                                                    <option value="<?= $responsable['id'] ?>"><?= $responsable['nombre'] . " " . $responsable['lastname'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" name="btn-printer" class="btn btn-success">Guardar</button>
                            </div>
                        </form>
                    </div>
                </div>
