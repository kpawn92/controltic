...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Entrada de las Memorias RAM</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item">Memorias RAM</li>
                    ...
                    <div class="card card-success">
                        ...
                        <form method="POST" action="<?= site_url("/reg_ram") ?>" id="quickForm">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="capacidad" name="capacidad" placeholder="Entre la capacidad de la memoria RAM">
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="card-footer">
                                <button type="submit" name="btn-ram" class="btn btn-success">Guardar</button>
                            </div>
                        </form>
                    </div>
                </div>
