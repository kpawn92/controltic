                    ...
                    <div class="card card-success">
                        ...
                        <form method="POST" action="<?= site_url("/reg_placa") ?>" id="quickForm">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="socket" name="socket" placeholder="Entre el socket de la placamadre">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="numserie" name="numserie" placeholder="Entre el numero de serie de la placamadre">
                                        </div>
                                        <label>Estado T&eacute;nico la placa madre:</label>
                            ...
                            <div class="card-footer">
                                <button type="submit" name="btn-placa" class="btn btn-success">Guardar</button>
                            </div>
                        </form>
                    </div>
                </div>
