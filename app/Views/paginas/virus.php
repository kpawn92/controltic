                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="efectos_negativo" name="efectos_negativo" placeholder="Efectos negativos que pueda repercutir dicha incidencia">
                                        </div>
                                        <div class="form-group">
                                            <label for="accion">Acci&oacute;n:</label>
                                            <input type="text" class="form-control" id="accion" name="accion" placeholder="Accion que se ejecuto">
                                        </div>
                                        <div class="form-group">
